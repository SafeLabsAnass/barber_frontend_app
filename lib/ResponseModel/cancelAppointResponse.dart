...
class CancelAppoinmentData {
  ...
  String? createdAt;
  String? updatedAt;
  List<CancelAppoitmentServices>? services;
  ...
  CancelAppoinmentData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['services'] != null) {
      services = <CancelAppoitmentServices>[];
      json['services'].forEach((v) {
        services!.add(new CancelAppoitmentServices.fromJson(v));
      });
    }
...
class CancelAppoitmentServices {
  int? serviceId;
  int? catId;
  int? salonId;
  String? image;
  ...
  CancelAppoitmentServices.fromJson(Map<String, dynamic> json) {
    serviceId = json['service_id'];
    catId = json['cat_id'];
    salonId = json['salon_id'];
    image = json['image'];
