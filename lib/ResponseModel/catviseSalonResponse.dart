class CategoryWiseSalonResponse {
  String? msg;
  List<CatSalonData>? data;
  bool? success;

  CategoryWiseSalonResponse({this.msg, this.data, this.success});

  CategoryWiseSalonResponse.fromJson(Map<String, dynamic> json) {
    msg = json['msg'];
    if (json['data'] != null) {
      data = <CatSalonData>[];
      json['data'].forEach((v) {
        data!.add(new CatSalonData.fromJson(v));
      });
    }
...
class CatSalonData {
  ...
  String? imagePath;
  String? ownerName;
  CategoryWiseSalonOwnerDetails? ownerDetails;
  ...
  CatSalonData.fromJson(Map<String, dynamic> json) {
    ...
    ownerDetails = json['ownerDetails'] != null
        ? new CategoryWiseSalonOwnerDetails.fromJson(json['ownerDetails'])
        : null;
  }
...
class CategoryWiseSalonOwnerDetails {
  int? id;
  String? name;
  String? image;
  String? email;
  ...
  CategoryWiseSalonOwnerDetails.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    image = json['image'];
    email = json['email'];
