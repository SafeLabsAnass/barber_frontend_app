                                      ...
                                      return GestureDetector(
                                        onTap: () {
                                          ...
                                          setState(() {
                                            ...
                                            if (categoryList[index].service!.length > 0) {
                                              dataVisible = true;
                                              noDataVisible = false;

                                              catService.addAll(categoryList[index].service!);
                                              var catServiceLength = catService.length;
                                          ...
                                          child: TextButton(
                                            ...
                                            style: TextButton.styleFrom(
                                              ...
                                              shape: RoundedRectangleBorder(
                                                  ...
                                                  side: BorderSide(color: isSelected ? pinkColor : greyA5)),
                                            ),
                                            child: Text(
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Container(
                                          ...
                                          child: Text("",
                                              style: TextStyle(
                                                  color: blackColor, fontWeight: FontWeight.w800, fontSize: 16)),
                                        ),
                                        Container(
                                ...
                                Container(
                                  ...
                                  child: ListView(shrinkWrap: true, physics: NeverScrollableScrollPhysics(), children: <
                                    ...
                                    Visibility(
                                      visible: dataVisible,
                                      child: Container(
                                        margin: EdgeInsets.only(top: 0.0, left: 15, right: 0, bottom: 130),
                                        child: ListView.builder(
                                          shrinkWrap: true,
                                          physics: NeverScrollableScrollPhysics(),
                                          itemBuilder: (BuildContext context, int index) {
                                            var catId = categoryList[currentSelectedIndex].catId;
                                            var serId = catService[index].serviceId;
                                            print("serId:$serId" + "  " + "catId:$catId");
                                            print("value123456:$serId");

                                            var color = catService[index].isSelected ? pinkColor : greyA5;
                                                  ...
                                                  children: <Widget>[
                                                    ...
                                                    new Container(
                                                      ...
                                                      child: CachedNetworkImage(
                                                        ...
                                                        width: 35,
                                                        imageUrl:
                                                            catService[index].imagePath! + catService[index].image!,
                                    ...
                                    Visibility(
                                      ...
                                      child: SizedBox(
                                        ...
                                        height: 130,
                                        child: Container(
                                          transform: Matrix4.translationValues(5.0, 50.0, 0.0),
                                          child: Center(
                                            child: Container(
                                                width: screenWidth,
                                                height: screenHeight,
                                  ...
                                  onPressed: () {
                                    if (PreferenceUtils.getlogin(AppConstant.isLoggedIn) == true) {
                                      ...
                                      Navigator.of(context).push(MaterialPageRoute(
                                          builder: (context) => new BookAppoitment(totalprice, _selectedServices,
                                              salonId, _selectedServicesName, _totalprice, salonData)));
                                    } else {
