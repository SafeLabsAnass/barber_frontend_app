...
class AppConstant {
  ...
  static final String currencySymbol = "currency";

  static final String disclaimerDialog = "";
  ...
  static Future<String> getDistance(double lat, double long) async {
    ...
    if (places.isNotEmpty && places.isNotEmpty) {
      ...
      double distanceInMeters = Geolocator.distanceBetween(position.latitude, position.longitude, salonLat, salonLong);
